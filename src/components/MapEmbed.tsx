      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-6 text-center">
          ...
          <div className="flex justify-center mt-4">
            <iframe src="https://www.trip.com/partners/ad/SB15353074?Allianceid=7974128&SID=300882170&trip_sub1=" style={{width: "728px", height: "90px", border: "none"}} frameBorder="0" scrolling="no" id="SB15353074"></iframe>
          </div>
        </div>
      </div>
    </section>
