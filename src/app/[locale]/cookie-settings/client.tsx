      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mt-12 p-6 rounded-lg bg-black/5 dark:bg-white/5 border border-[var(--border-color)]">
          <h2 className="text-lg font-semibold mb-3 text-[var(--text-primary)]">
            {locale === 'zh-hans' ? '广告与联盟声明' : 
             locale === 'zh-hant' ? '廣告與聯盟聲明' : 
             locale === 'ka' ? 'სარეკლამო და აფილირებული განცხადება' :
             locale === 'ru' ? 'Реклама и партнерское заявление' : 
             'Advertising & Affiliate Disclaimer'}
          </h2>
